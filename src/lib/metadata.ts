...
import { generateSeoMetadata, SITE_URL } from '@/lib/seo/generateSeoMetadata'
...
const metaData: Record<PageKey, { pl: { title: string; description: string }; en: { title: string; description: string } }> = {
  home: {
    pl: {
