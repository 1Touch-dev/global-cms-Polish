...
export const metadata: Metadata = {
  ...
  description: 'Matchday Arena — polska piłka i Ekstraklasa. Wyniki na żywo, tabela i terminarz.',
  keywords: ['Matchday Arena', 'Ekstraklasa', 'polska piłka', 'wyniki na żywo', 'piłka nożna'],
